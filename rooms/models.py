...
SPACE_TYPES = [(1, "Entire Place"), (2, "Private Room"), (3, "Shared Room")]
...
PHOTO_TYPES = [
    (1, "Inside of the place"),
    (2, "View of the place"),
    (3, "External appearance of the place"),
    (4, "Around the place"),
    (4, "Other"),
]
...
class Room(models.Model):
    ...
    room_type = models.SmallIntegerField(choices=PLACE_TYPES, default=1)
    ...
    accuracy_rating = models.SmallIntegerField(choices=PLACE_RATING, default=0)
    location_rating = models.SmallIntegerField(choices=PLACE_RATING, default=0)
    communication_rating = models.SmallIntegerField(choices=PLACE_RATING, default=0)
    checkin_rating = models.SmallIntegerField(choices=PLACE_RATING, default=0)
    clean_rating = models.SmallIntegerField(choices=PLACE_RATING, default=0)
    value_rating = models.SmallIntegerField(choices=PLACE_RATING, default=0)
